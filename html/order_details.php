					...
					<div class="wrap-table-shopping-cart">
						<table class="table-shopping-cart">
							<tr class="table_head">
								...
								<?php if($coupon_value != ''){ ?><th class="column-5">Discount Value</th> <?php } ?>
							</tr>
							<?php
							...
							?>
								<tr class="table_row">
									...
									<?php if($coupon_value != ''){ ?><td class="column-5"><?php echo $coupon_value ?></td> <?php } ?>
								</tr>
							<?php }
							?>
							<tr class="table_row">
								...
								<td class="column-3"> <strong> Final Price </strong></td>
								<td class="column-4" style="text-align:center"> ₹<?php if($coupon_value != ''){ echo $total_price - $coupon_value; } else { echo $total_price;}?> </td>
