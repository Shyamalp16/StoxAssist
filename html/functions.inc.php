...
function get_product($con,$limit='',$cat_id='',$product_id='',$search='',$sub_cat=''){
    ...
    if($sub_cat!=''){
      $sql.=" and product.sub_category_id=$sub_cat ";
  }
...
function sendInvoice($con, $order_id){
    ...
    $user_order=mysqli_fetch_assoc(mysqli_query($con,"select orders.*, users.name,users.email from orders,users where users.id=orders.user_id and orders.id='$order_id'"));
    
    $cup = mysqli_query($con, "select coupon_value from orders where id='$order_id'");
    $cupnum = mysqli_fetch_array($cup);
    $coupon_value = $cupnum['coupon_value'];
    $total_price = 0;
    ...
    <html>
      ...
      <body style="color:black;">
                ...
                <tr>
                      ...
                      <tr>
                        <td class="content-cell">
                          <div class="f-fallback">
                            ...
                            <p>Thanks for using StoxAssist. This is an invoice for your recent purchase.</p>
                  ...
                  <strong>Amount:</strong> '.$user_order['total_price'].'
                            ...
                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td>
                                  <h3>Invoice ID:'.$user_order['id'].'</h3>
                                </td>
                                <td>
                              ...
                              <tr>
                                <td colspan="2">
                                  <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    $html.='
                                    <tr>
                                        <td width="80%" class="purchase_item"><span class="f-fallback" style="color:black;">'.$row['name'].'</span></td>
                                        <td class="align-right" width="20%" class="purchase_item"><span class="f-fallback">'.$total_price.'</span></td>
                                    </tr>';
                                    } 
                                    ...
                                    if($coupon_value != ''){
                                      ...
                                      $html.='<td width="20%" class="purchase_footer" valign="middle">
                                        <p class="f-fallback purchase_total">'.$total_price - $coupon_value.'</p>
                                      </td>';
                                    }else{
                                        $html.='<td width="20%" class="purchase_footer" valign="middle">
                            ...
                            <p>If you have any questions about this invoice, simply reply to this email or reach out to our <a href="http://localhost/StoxAssist/html/contact.php">Website</a> for help.</p>
                            <p>Cheers,
                              <br>The StoxAssist Team</p>
                            <!-- Sub copy -->
                    ...
                    <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        <td class="content-cell" align="center">
                          <p class="f-fallback sub align-center">&copy; 2021</p>
        ...
        $mail->IsHTML(true);
        $mail->Subject="Invoice Of Your Recent Purchase";
        $mail->Body=$html;
