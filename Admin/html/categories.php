<?php 
    ...
    if(isset($_GET['type']) && $_GET['type']!=''){
        ...
        if($type=='delete'){
            $id=get_safe_value($con,$_GET['id']);
            $delete_status_sql="delete from categories where id='$id'";
            Header('Location: '.$_SERVER['PHP_SELF']);
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary text-right"><a href="add_categories.php">Add Categories</a></h6>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td>
                                                <?php
                                                    if($row['status']==1){
                                                     ...
                                                     echo "&nbsp; <a href='edit_categories.php?id=".$row['id']."'><button class='btn btn-circle btn-info'>Edit</button></a> &nbsp;";
                                                ?>
                                            </td>
                                            <td>
                                                <?php
