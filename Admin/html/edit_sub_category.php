<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($msg==''){
            if(isset($_GET['id']) && $_GET['id'] != ''){
                mysqli_query($con,"update sub_category set category_id='$category',sub_category='$sub_category' where id='$id'");
               }else{
                                            ...
                                            <form class=user method=post>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-10 d-none d-lg-block">    
                                                        ...
                                                        <input type="text" class="form-control form-control-user" name="sub_category" id="sub_category"
                                                        placeholder="Sub Category Name" value="<?php echo $sub_category ?>" required autofocus> 
                                                    </div>
                                                    <br>
                                                </div>
                                                <div class="flex">
