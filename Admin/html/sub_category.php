<?php 
    ...
    // $sql = "select * from sub_category order by sub_category desc";
    $sql = "select sub_category.*,categories.categories from sub_category,categories where categories.id=sub_category.category_id order by sub_category.sub_category asc";
    ...
    if(isset($_GET['type']) && $_GET['type']!=''){
        ...
        if($type=='delete'){
            $id=get_safe_value($con,$_GET['id']);
            $delete_status_sql="delete from sub_category where id='$id'";
            Header('Location: '.$_SERVER['PHP_SELF']);
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary text-right"><a href="add_sub_category.php">Add Sub Categories</a></h6>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td>
                                                <?php
                                                    if($row['status']==1){
                                                     ...
                                                     echo "&nbsp; <a href='edit_sub_category.php?id=".$row['id']."'><button class='btn btn-circle btn-info'>Edit</button></a> &nbsp;";
                                                ?>
                                            </td>
                                            <td>
                                                <?php
