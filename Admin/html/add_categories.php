                                    ...
                                    <div class=col-lg-7>
                                        <div class=p-5>
                                            <div class=text-center>
                                                <h1 class="h4 text-gray-900 mb-4">Add New Categories</h1>
                                            </div>
                                            <form class=user method=post>
                                                <div class=form-group>
                                                    <div class="col-lg-10 d-none d-lg-block">    
                                                        <label for=categories class=form-control-label>Categories:</label>
                                                        <input class="form-control form-control-user" name=category id=category placeholder="Category Name" required autofocus>
                                                    </div>
                                                    <br>
                                                </div>
