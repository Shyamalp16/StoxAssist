                                            ...
                                            <form class="user" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-10 d-none d-lg-block">
                                                        ...
                                                        placeholder="Enter product Meta Title (OPTIONAL)"></textarea>
                                                    </div>
								                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-10 d-none d-lg-block">
                                                        ...
                                                        placeholder="Enter Product Meta Description (OPTIONAL)"></textarea>
                                                    </div>
								                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-10 d-none d-lg-block">
                                                        ...
                                                        placeholder="Enter Product Meta Keyword (OPTIONAL)"></textarea>
                                                    </div>
								                </div>
